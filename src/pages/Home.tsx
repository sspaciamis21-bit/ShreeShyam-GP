    ...
    <div>
      ...
      <section className="hero-section">
        ...
        <div className="container">
          <div className="hero-grid">
            <div>
              ...
              <h1 className="hero-title">
                Building Futures. <br />
                <span className="gradient-gold-text">Empowering Growth.</span>
              </h1>
              <p className="hero-subtitle">
                Shree Shyam Group of Companies is a diversified business group specializing in official <strong>GeM (Government e-Marketplace) portal orders & government supplies</strong>, landmark <strong>construction & infrastructure projects</strong>, and vibrant managed workspaces through <strong>Sspacia Coworking</strong>.
              </p>
              ...
              <div style={{ display: 'flex', gap: '1.5rem', marginTop: '2.5rem', paddingTop: '1.5rem', borderTop: '1px solid var(--border-color)' }}>
            ...
            <div className="glass-card" style={{ padding: '2rem', border: '1px solid var(--border-gold)' }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1.5rem' }}>
                ...
                <span className="badge badge-blue">Group Structure</span>
              </div>

              <div style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
                {/* Division 1: GeM */}
                <div style={{ padding: '1rem', background: 'rgba(2, 132, 199, 0.08)', borderRadius: 'var(--radius-sm)', border: '1px solid rgba(2, 132, 199, 0.2)' }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '0.35rem' }}>
                    <ShieldCheck size={20} color="#38bdf8" />
                    <h4 style={{ fontSize: '1rem', color: '#38bdf8' }}>GeM Portal & Govt Supplies</h4>
                  </div>
                ...
                <div style={{ padding: '1rem', background: 'rgba(217, 119, 6, 0.08)', borderRadius: 'var(--radius-sm)', border: '1px solid rgba(217, 119, 6, 0.2)' }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '0.35rem' }}>
                    <Building2 size={20} color="#fbbf24" />
                    <h4 style={{ fontSize: '1rem', color: '#fbbf24' }}>Construction & Infrastructure</h4>
                  </div>
                  <p style={{ fontSize: '0.85rem', color: 'var(--text-muted)' }}>
                ...
                {/* Division 3: Sspacia */}
                <div style={{ padding: '1rem', background: 'rgba(139, 92, 246, 0.08)', borderRadius: 'var(--radius-sm)', border: '1px solid rgba(139, 92, 246, 0.2)' }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '0.35rem' }}>
                    <LayoutGrid size={20} color="#c084fc" />
                    <h4 style={{ fontSize: '1rem', color: '#c084fc' }}>Sspacia Coworking Spaces</h4>
                  </div>
                  <p style={{ fontSize: '0.85rem', color: 'var(--text-muted)' }}>
          ...
          {/* Group Stats Ribbon */}
          <div className="glass-card stats-ribbon" style={{ marginTop: '5rem' }}>
      ...
      <section style={{ padding: '5rem 0', background: 'var(--bg-surface)' }}>
        <div className="container">
          <div style={{ textAlign: 'center', maxWidth: '700px', margin: '0 auto 4rem' }}>
            <span className="badge badge-gold" style={{ marginBottom: '0.75rem' }}>Our Core Competencies</span>
            <h2 style={{ fontSize: '2.5rem', marginBottom: '1rem' }}>Diversified Industry Leadership</h2>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))', gap: '2rem' }}>
            ...
            <div className="glass-card" style={{ padding: '2.5rem', display: 'flex', flexDirection: 'column' }}>
              <div style={{ width: '50px', height: '50px', borderRadius: '12px', background: 'rgba(2, 132, 199, 0.15)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#38bdf8', marginBottom: '1.5rem' }}>
                <ShieldCheck size={28} />
              </div>
              <span className="badge badge-blue" style={{ alignSelf: 'flex-start', marginBottom: '0.75rem' }}>Government e-Marketplace</span>
              <h3 style={{ fontSize: '1.5rem', marginBottom: '0.75rem' }}>GeM Vendor & Supply Operations</h3>
            ...
            <div className="glass-card" style={{ padding: '2.5rem', display: 'flex', flexDirection: 'column' }}>
              ...
              <h3 style={{ fontSize: '1.5rem', marginBottom: '0.75rem' }}>Construction & Infrastructure</h3>
              <p style={{ color: 'var(--text-muted)', fontSize: '0.95rem', flexGrow: 1, marginBottom: '1.5rem' }}>
            ...
            {/* Card 3: Sspacia */}
            <div className="glass-card" style={{ padding: '2.5rem', display: 'flex', flexDirection: 'column' }}>
              <div style={{ width: '50px', height: '50px', borderRadius: '12px', background: 'rgba(139, 92, 246, 0.15)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#c084fc', marginBottom: '1.5rem' }}>
                <LayoutGrid size={28} />
              </div>
              <span className="badge badge-purple" style={{ alignSelf: 'flex-start', marginBottom: '0.75rem' }}>Founded by Praveen Agarwal</span>
              <h3 style={{ fontSize: '1.5rem', marginBottom: '0.75rem' }}>Sspacia Coworking Spaces</h3>
              <p style={{ color: 'var(--text-muted)', fontSize: '0.95rem', flexGrow: 1, marginBottom: '1.5rem' }}>
      ...
      <section style={{ padding: '5rem 0' }}>
        <div className="container">
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', marginBottom: '3rem', flexWrap: 'wrap', gap: '1rem' }}>
            <div>
              <span className="badge badge-gold" style={{ marginBottom: '0.5rem' }}>Visionary Leadership</span>
              <h2 style={{ fontSize: '2.25rem' }}>Guided by Experience & Enterprise</h2>
            </div>
            <Link to="/about" className="btn btn-outline">
              <span>Meet Full Executive Team (4 Members)</span>
              <ArrowRight size={16} />
            </Link>
          </div>
      ...
      {/* CTA Callout */}
      <section style={{ padding: '4rem 0', background: 'linear-gradient(135deg, rgba(230, 193, 92, 0.1) 0%, rgba(2, 132, 199, 0.1) 100%)', borderTop: '1px solid var(--border-color)', borderBottom: '1px solid var(--border-color)' }}>
        <div className="container" style={{ textAlign: 'center', maxWidth: '800px' }}>
          <h2 style={{ fontSize: '2.5rem', marginBottom: '1rem' }}>Partner with Shree Shyam Group</h2>
